package com.example.notification.ui.notifications
...
class NotificationsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        createNotifocacion(requireContext())

        val textView: TextView = binding.textNotifications
        val btnView: Button = binding.btnNotifications
        notificationsViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }

        btnView.setOnClickListener{
            Toast.makeText(requireContext(), "Hola notificacion", Toast.LENGTH_SHORT).show()
    ...
    private fun createNotifocacion(context: Context){
